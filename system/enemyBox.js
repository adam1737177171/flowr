const noEnemyBox = ["Ant Egg", "Fire Ant Egg"];
class enemyBox {
...
function createEnemyBox(i, room) {
	...
	if (foundType == false) {
		...
		room.enemyBoxes.push(new enemyBox(i, i.rarity, i.customType ?? i.type, spawnX, spawnY, enemyBoxSize, enemyBoxSize, i.isBoss));
